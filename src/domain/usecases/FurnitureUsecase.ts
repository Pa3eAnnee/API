...
import {
	type CreateFurnitureRequest,
	type UpdateFurnitureRequest,
	createFurnitureValidation,
	updateFurnitureValidation,
} from "../../handlers/validators/furniture-validator";
...
export class FurnitureUsecase {
	...
	async createFurniture(
		furnitureData: CreateFurnitureRequest,
	): Promise<Furniture> {
	...
	async updateFurniture(
		id: number,
		furnitureData: UpdateFurnitureRequest,
