...
import { CreateAttendRequest, UpdateAttendRequest, createAttendValidation, updateAttendValidation } from '../../handlers/validators/attend-validator';
...
export class AttendUsecase {
    ...
    async updateAttend(id: number, attendData: UpdateAttendRequest): Promise<Attend | null> {
        // Validate attendData against the schema
