...
import { CreateExpanseRequest, UpdateExpanseRequest, createExpanseValidation, updateExpanseValidation } from '../handlers/validators/expanse-validator';
...
export class ExpanseUsecase {
    ...
    async updateExpanse(id: number, expanseData: UpdateExpanseRequest): Promise<Expanse | null> {
        // Validate expanseData against the schema
