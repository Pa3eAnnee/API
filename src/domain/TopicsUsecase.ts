...
import { CreateTopicsRequest, UpdateTopicsRequest, createTopicsValidation, updateTopicsValidation } from '../handlers/validators/topics-validator';
...
export class TopicsUsecase {
    ...
    async updateTopics(id: number, topicsData: UpdateTopicsRequest): Promise<Topics | null> {
        // Validate topicsData against the schema
