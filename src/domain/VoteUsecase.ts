...
import { CreateVoteRequest, UpdateVoteRequest, createVoteValidation, updateVoteValidation } from '../handlers/validators/vote-validator';
...
export class VoteUsecase {
    ...
    async updateVote(id: number, voteData: UpdateVoteRequest): Promise<Vote | null> {
        // Validate voteData against the schema
