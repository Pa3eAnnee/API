...
import {
    CreateVoteTableRequest,
    createVoteTableValidation,
    UpdateVoteTableRequest, updateVoteTableValidation
...
export class VoteTableUsecase {
    ...
    async createVoteTable(voteTableData: CreateVoteTableRequest): Promise<VoteTable> {
    ...
    async updateVoteTable(id: number, voteTableData: UpdateVoteTableRequest): Promise<VoteTable | null> {
        // Validate voteTableData against the schema
