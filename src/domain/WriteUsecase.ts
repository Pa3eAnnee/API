...
import { CreateWriteRequest, UpdateWriteRequest, createWriteValidation, updateWriteValidation } from '../handlers/validators/write-validator';
...
export class WriteUsecase {
    ...
    async updateWrite(id: number, writeData: UpdateWriteRequest): Promise<Write | null> {
        // Validate writeData against the schema
